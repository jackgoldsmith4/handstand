...
export const WORKOUT_DATA: DayPlan[] = [
  // ── Day 1 ──
  {
    ...
    exercises: [
      ...
      e(1,5,'Puppy pose','60 sec', { timerSeconds: 60 }),
  ...
  // ── Day 14 — MILESTONE ──
  {
    ...
    exercises: [
      ...
      e(14,4,'Headstand','3 × 15 sec', { sets: 3, timerSeconds: 15 }),
      e(14,5,'Pike push-ups','4 × 8', { sets: 4 }),
      e(14,6,'Full shoulder mobility circuit','Puppy pose (60s), wall slides (2×10), doorway stretch (30s)', { timerSeconds: 60 }),
    ],
  },
  // ── Day 15 ──
  {
    ...
    exercises: [
      ...
      e(15,4,'Headstand','3 × 20 sec', { sets: 3, timerSeconds: 20 }),
  ...
  // ── Day 16 ──
  {
    ...
    exercises: [
      ...
      e(16,4,'Headstand','3 × 20 sec', { sets: 3, timerSeconds: 20 }),
      e(16,5,'Pike push-ups','4 × 8', { sets: 4 }),
      e(16,6,'Puppy pose','60 sec', { timerSeconds: 60 }),
      e(16,7,'Standing forward fold','60 sec', { timerSeconds: 60 }),
  ...
  // ── Day 18 ──
  {
    ...
    exercises: [
      ...
      e(18,5,'Headstand','3 × 20 sec', { sets: 3, timerSeconds: 20 }),
  ...
  // ── Day 23 ──
  {
    ...
    exercises: [
      ...
      e(23,6,'Standing forward fold','60 sec', { timerSeconds: 60 }),
      e(23,7,'Doorway shoulder stretch','30 sec', { timerSeconds: 30 }),
    ],
  },
  // ── Day 24 — REST ──
  ...
  // ── Day 41 ──
  {
    ...
    exercises: [
      ...
      e(41,5,'Kick-up practice','15 attempts — lunge stance, controlled kick, aim to touch wall', { sets: 15, isGoal: true, goalText: 'Controlled drive — do NOT kick hard' }),
  ...
  // ── Day 50 ──
  {
    ...
    exercises: [
      ...
      e(50,4,'Tuck handstand','5 attempts — kick up, pull knees to chest, hold', { sets: 5, timerSeconds: 3, isGoal: true, goalText: 'Target: 1-3 second holds using fingertip adjustments' }),
  ...
  // ── Day 59 ──
  {
    ...
    exercises: [
      ...
      e(59,4,'Single-leg extensions','3 × 3 each side — from tuck handstand, extend one leg up', { sets: 3 }),
  ...
  // ── Day 60 — MILESTONE ──
  {
    ...
    exercises: [
      ...
      e(60,4,'Single-leg extensions','3 × 3 each side', { sets: 3 }),
  ...
  // ── Day 61 ──
  {
    ...
    exercises: [
      ...
      e(61,4,'Single-leg extensions','3 × 5 each side', { sets: 3 }),
  ...
  // ── Day 62 ──
  {
    ...
    exercises: [
      ...
      e(62,4,'Single-leg extensions','3 × 5 each side', { sets: 3 }),
  ...
  // ── Day 64 ──
  {
    ...
    exercises: [
      ...
      e(64,4,'Single-leg extensions','3 × 5 each side', { sets: 3 }),
  ...
  // ── Day 66 ──
  {
    ...
    exercises: [
      ...
      e(66,5,'Single-leg extensions','3 × 5 each side', { sets: 3 }),
  ...
  // ── Day 68 ──
  {
    ...
    exercises: [
      ...
      e(68,4,'Freestanding kick-ups','20 attempts — try to float without wall', { sets: 20 }),
  ...
  // ── Day 73 ──
  {
    ...
    exercises: [
      ...
      e(73,5,'Single-leg extensions','3 × 5 each side', { sets: 3 }),
  ...
  // ── Day 95 ──
  {
    ...
    exercises: [
      ...
      e(95,5,'Single-leg extensions','5 × 5 each side', { sets: 5 }),
