...
export const WORKOUT_DATA: DayPlan[] = [
  ...
  // ── Day 12 ──
  {
    ...
    exercises: [
      ...
      e(12,6,'Active pike compression','3 × 10 — seated, lift straight legs off floor', { sets: 3 }),
      e(12,7,'Standing forward fold','60 sec', { timerSeconds: 60 }),
    ],
  },
  // ── Day 13 — REST ──
  ...
  // ── Day 31 ──
  {
    ...
    exercises: [
      ...
      e(31,5,'Active pike compression','3 × 15', { sets: 3 }),
    ],
  },
  // ── Day 32 — REST ──
  ...
  // ── Day 34 ──
  {
    ...
    exercises: [
      ...
      e(34,5,'Handstand shrugs','3 × 10', { sets: 3 }),
  ...
  // ── Day 37 ──
  {
    ...
    exercises: [
      ...
      e(37,3,'HSPU negatives','3 × 3', { sets: 3 }),
      e(37,4,'Chest-to-wall handstand','3 × max hold', { sets: 3 }),
  ...
  // ── Day 39 ──
  {
    ...
    exercises: [
      ...
      e(39,5,'Shoulder taps','3 × 5 per side', { sets: 3 }),
      e(39,6,'Hollow body hold','3 × 60 sec', { sets: 3, timerSeconds: 60 }),
    ],
  },
  // ── Day 40 — REST ──
  ...
  // ── Day 45 ──
  {
    ...
    exercises: [
      ...
      e(45,6,'Hollow body hold','3 × 60 sec', { sets: 3, timerSeconds: 60 }),
    ],
  },
  // ── Day 46 ──
  {
  ...
  // ── Day 48 ──
  {
    ...
    exercises: [
      ...
      e(48,6,'Full flexibility routine','Pigeon, forward fold, high lunge'),
    ],
  },
  // ── Day 49 ──
  {
  ...
  // ── Day 64 ──
  {
    ...
    exercises: [
      ...
      e(64,6,'Wall floats','5 tries — from chest-to-wall, peel BOTH feet off wall', { sets: 5, isGoal: true, goalText: 'First freestanding floats — any time counts' }),
    ],
  },
  // ── Day 65 ──
  {
  ...
  // ── Day 70 ──
  {
    ...
    exercises: [
      ...
      e(70,5,'Straddle handstand','5 × max hold', { sets: 5 }),
      e(70,6,'Full flexibility routine','Pigeon, forward fold, overhead stretch'),
    ],
  },
  // ── Day 71 — REST ──
  ...
  // ── Day 79 ──
  {
    ...
    exercises: [
      ...
      e(79,6,'Hollow body hold','3 × 60 sec', { sets: 3, timerSeconds: 60 }),
    ],
  },
  // ── Day 80 — REST ──
  ...
  // ── Day 81 ──
  {
    ...
    exercises: [
      ...
      e(81,4,'Straddle handstand','5 × max hold', { sets: 5 }),
      e(81,5,'Max hold attempts','3 dedicated attempts', { sets: 3 }),
      e(81,6,'Hollow body hold','3 × 60 sec', { sets: 3, timerSeconds: 60 }),
    ],
  },
  // ── Day 82 ──
  {
  ...
  // ── Day 86 ──
  {
    ...
    exercises: [
      ...
      e(86,6,'Full flexibility routine','Pigeon, forward fold, overhead stretch'),
    ],
  },
  // ── Day 87 ──
  {
    ...
    exercises: [
      ...
      e(87,5,'Straddle handstand','5 × max hold', { sets: 5 }),
  ...
  // ── Day 95 ──
  {
    ...
    exercises: [
      ...
      e(95,5,'Straddle handstand','5 × max hold', { sets: 5 }),
  ...
  // ── Day 98 ──
  {
    ...
    exercises: [
      ...
      e(98,6,'Tuck-to-straight extension','5 × 5', { sets: 5 }),
    ],
  },
  // ── Day 99 ──
  {
